...
const rom char* UnityStrNull     = "NULL";
const rom char* UnityStrSpacer   = ". ";
const rom char* UnityStrExpected = " Expected ";
const rom char* UnityStrWas      = " Was ";
const rom char* UnityStrTo       = " To ";
const rom char* UnityStrElement  = " Element ";
const rom char* UnityStrByte     = " Byte ";
const rom char* UnityStrMemory   = " Memory Mismatch.";
const rom char* UnityStrDelta    = " Values Not Within Delta ";
const rom char* UnityStrPointless= " You Asked Me To Compare Nothing, Which Was Pointless.";
const rom char* UnityStrNullPointerForExpected= " Expected pointer to be NULL";
const rom char* UnityStrNullPointerForActual  = " Actual pointer was NULL";
const rom char* UnityStrInf      = "Infinity";
const rom char* UnityStrNegInf   = "Negative Infinity";
const rom char* UnityStrNaN      = "NaN";
...
//-----------------------------------------------
void UnityPrintSingleChar(char c)
{
    ...
    {
        UNITY_OUTPUT_CHAR('\\');
        UnityPrintNumberHex((_U_SINT)c, 2);
    }
}

void UnityPrintRAM(const char* string)
{
    ...
    if (pch != NULL)
    {
        while (*pch)
        {
            UnityPrintSingleChar(*pch);
            pch++;
        }
    }
}

void UnityPrint(const rom char* string)
{
...
//-----------------------------------------------
void UnityTestResultsBegin(const rom char* file, const UNITY_LINE_TYPE line)
{
    UnityPrint(file);
    UNITY_OUTPUT_CHAR(':');
...
//-----------------------------------------------
void UnityAddMsgIfSpecified(const rom char* msg)
{
    if (msg)
    {
...
int UnityCheckArraysForNull(const void* expected, const void* actual, const UNITY_LINE_TYPE lineNumber, const rom char* msg)
{
...
void UnityFail(const rom char* msg, const UNITY_LINE_TYPE line)
{
    UNITY_SKIP_EXECUTION;
...
//-----------------------------------------------
void UnityIgnore(const rom char* msg, const UNITY_LINE_TYPE line)
{
    UNITY_SKIP_EXECUTION;
...
void setUp(void);
void tearDown(void);
void UnityDefaultTestRun(UnityTestFunction Func, const rom char* FuncName, const int FuncLineNum)
{
