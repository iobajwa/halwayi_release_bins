...
struct _Unity
{
    const rom char* TestFile;
    const rom char* CurrentTestName;
...
void UnityFail(const rom char* message, const UNITY_LINE_TYPE line);

void UnityIgnore(const rom char* message, const UNITY_LINE_TYPE line);
